...
import HeroImg from '../../../public/home/hero1.jpg';

export const Hero = () => {
	return (
		<section className='relative'>
			<div className='container flex flex-col-reverse lg:flex-row items-center gap-12 mt-14 lg:mt-36'>
				{/* content */}
				...
				<div className='flex justify-center flex-1 mb-10 md:mb-16 lg:mb-0 z-10'>
					<Image
						src={HeroImg}
						alt='Hero Image'
						className='w-5/6 h-5/6 sm:w-3/4 md:h-full'
					/>
				</div>
			</div>
			{/* Rounded Rectangle */}
			{/* <div className='hidden md:block overflow-hidden bg-pet-indigo rounded-l-full absolute h-80 w-2/4 top-32 right-0 lg:-bottom-28 lg:-right-36'></div> */}
		</section>
	);
};
